	...
	>
		<div class="h-full overflow-y-auto border-r border-gray-200 bg-gray-50 px-2 py-3">
			<a
				...
				target="_blank"
				class="flex items-center justify-center gap-2 rounded-lg px-2 py-1 text-gray-700 outline-hidden hover:text-gray-900 focus:border-gray-500 focus:ring focus:ring-gray-500"
			>
				<svg
					width="24"
					height="24"
			...
			<ul class="mt-6 flex flex-col gap-1 font-medium">
				...
				>
					<a
						...
						class="flex items-center rounded-lg border px-3 py-2 text-gray-800 outline-hidden transition-colors duration-150 focus:border-gray-500 focus:ring focus:ring-gray-500"
					>
						<component
							:is="item.icon"
							:size="18"
